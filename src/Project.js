      ...
      <div className="container">
        <div className="row">
          <div className="col__3">
            <div className="project__box pointer relative">
              ...
              <div className="project__meta absolute">
                ...
                <a href="https://github.com/shivanshudev63/PERSONAL-WEBSITE" target="_blank" className="project__btn">
                  View Details
                </a>
              </div>
            </div>
          ...
          <div className="col__3">
            <div className="project__box pointer relative">
              ...
              <div className="project__meta absolute">
                ...
                <a href="https://github.com/shivanshudev63/DRUM-KIT" className="project__btn"target="_blank">
                  View Details
                </a>
              </div>
            </div>
          ...
          <div className="col__3">
            <div className="project__box pointer relative">
              ...
              <div className="project__meta absolute">
                ...
                <h4 className="project__text">ToDo List</h4>
                <a href="https://github.com/shivanshudev63/ToDo-List-" className="project__btn" target="_blank">
                  View Details
                </a>
              </div>
            </div>
          ...
          <div className="col__3">
            <div className="project__box pointer relative">
              ...
              <div className="project__meta absolute">
                ...
                <a href="https://github.com/shivanshudev63/PING-PONG-GAME" className="project__btn" target="_blank">
                  View Details
                </a>
              </div>
            </div>
          ...
          <div className="col__3">
            <div className="project__box pointer relative">
              ...
              <div className="project__meta absolute">
                ...
                <a href="https://github.com/shivanshudev63/SIMON-GAME" className="project__btn" target="_blank">
                  View Details
                </a>
              </div>
            </div>
          ...
          <div className="view__more__btn d__flex align__items__center justify__content__center pxy__30">
            <a href="https://github.com/shivanshudev63?tab=repositories" target="_blank"><button className="view__more pointer btn">View more</button></a>
          </div>
        </div>
      </div>
    </div>
